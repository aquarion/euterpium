...
def main():
    ...
    # Report winrt status now that logging is definitely active
    if smtc.WINRT_AVAILABLE:
        logger.info("SMTC: winrt loaded — media session detection enabled")
    else:
        logger.warning("SMTC: winrt not available — only game audio fingerprinting will work")
